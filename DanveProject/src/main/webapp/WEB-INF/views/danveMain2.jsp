...
<body>
	<div class="mainIntro" style="position: relative;">
		<nav class="gnb-menu">
			<div>
				<a href="danveP.do">단비</a> <a href="docuP.do">다큐멘터리실험</a> <a href="">비건다짐</a>
				<a href="">공유하기</a>
			</div>
			<div>
		...
		<div id="fullpage">
			<section class="section">
				...
				<div style="margin-top: 9em; padding: 1em; width: 50;">
					<p>
						하루가 멀다 하고 급변하는 세상입니다. 단지 기술뿐 만에 이야기가 아닙니다. <br> 이미 가파른 지구 온도의
						상승으로 인하여 매일매일 비극적인 뉴스가 쏟아집니다. <br> 이런 상황에서 우리가 할 수 있는 가장 최고의
						행동이 바로 ‘채식’입니다. <br> 단비의 팀원들은 모두 환경문제, 동물권 등 각자의 이유로 비거니즘을
						실천하고 있습니다. <br> 단비의 팀원들은 왜? 비거니즘을 실천하게 되었을까요?
					</p>
				</div>
			</section>
			<section class="section">
			...
			<section class="section">
				<div class="introBox">
					...
					<p>감자는 평소 동료의 ‘약자성’과 ‘소수자성’ 등 인권문제를 의식하며 그들과 연대하기 위해 노력하고
						...
						자각하게 되었습니다. 그 후 SNS의 다른 비건이 작성한 글을 읽으며 비건을 결심하게 되었습니다. 그 결심에는 사람뿐만
						아니라 동물 또한 나의 동료라는 생각과, 동물이 그들의 존재, 그 자체로 살아 존중받을 수 있는 세상에 대한 열망이
						담겨있습니다.</p>
				</div>
				<div class="introBox">
					<h1>버섯</h1>
					<p>버섯이는 일전에 큰 화두였던 식용견에 대한 파장이 한창일 때, ‘개는 우리의 가족이며 친구이다. 그런 개들을
						어떻게 먹을 수가 있냐’ 라는 주장이 담긴 글을 접했습니다. 그런데 버섯이는 개와 돼지, 소, 닭도 다르지 않은데 단지
						‘개’라는 동물만을 차별하지 않느냐는 글을 발견합니다. 이후 그 글에 공감하며 스스로의 ‘종차별’에 대해 깨달아
						비거니즘을 실천하게 되었습니다.</p>
				</div>
			</section>
			<section class="section">
			...
			<section class="section">
				<div>
					<p>비건은 누구나 될 수 있습니다. 우리 모두는 비거니즘의 씨앗을 마음속에 품고 있는 것입니다. 씨앗은 적당한
						자리와 햇살이 갖춰진 상황에서 마지막 물 한 방울의 존재로 마침내 싹을 틔울 수 있습니다. 동물들의 삶, 환경의 오염,
						망가져가는 건강 등으로 몸살을 앓고 있는 우리의 마음속에 비건의 싹을 틔워 줄 알맞은 빗방울. 그 한 방울을 우리는
						나누려고합니다. 이로써 껍질을 뚫고 나온 새싹은 '단비'와 함께 무럭무럭 자라날 것입니다. 여럿의 새싹들이 모여서
						울창하고 단단한 숲을 이룰 때까지 함께 하겠습니다.</p>
				</div>
